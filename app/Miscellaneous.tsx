          ...
          <ul className="list-disc list-outside ml-6">
            <li className="mb-2">
              <a
                ...
                href="https://avinashmurugappan.dev/files/vc-list.pdf"
                target="_blank"
            ...
            <li className="mb-2">
              <a
                className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-100"
                href="https://avinashmurugappan.dev/files/deans-merit-list.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li className="mb-2">
              <a
                className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-100"
                href="https://avinashmurugappan.dev/files/deans-list.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
        ...
        <div className="max-w-3xl">
          ...
          <ul className="list-disc list-outside ml-6">
            <li className="mb-2">
              <a
                className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-100"
                href="https://avinashmurugappan.dev/files/icpc-asia-dhaka-2019.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li className="mb-2">
              <a
                className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-100"
                href="https://avinashmurugappan.dev/files/intra-iub-tech-fest-2019.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li className="mb-2">
              <a
                className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-100"
                href="https://avinashmurugappan.dev/files/acm-week-code-debugging-2019.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li className="mb-2">
              <a
                className="text-zinc-600 dark:text-zinc-400 hover:text-zinc-800 dark:hover:text-zinc-100"
                href="https://avinashmurugappan.dev/files/extracurricular.pdf"
                target="_blank"
                rel="noopener noreferrer"
              >
